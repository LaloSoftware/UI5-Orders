					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Details",
									"targetURL": "#OrderDetails-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"OrderDetails-display": {
								"semanticObject": "OrderDetails",
								"action": "display",
								"description": "other app for northwind",
								"title": "Order Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=localsap.orders.orders",
									"url": sap.ui.require.toUrl("localsap/orders/orders")
								}
							}
						}
					}
