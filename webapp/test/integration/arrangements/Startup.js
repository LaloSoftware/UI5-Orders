sap.ui.define([
	"sap/ui/test/Opa5",
	"localsap/orders/orders/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("localsap.orders.orders.test.integration.arrangements.Startup", {
